...
<script>
  ...
  import { GET_SHOP_LIST, GET_MARKETING_TASK_LIST, GET_MARKETING_TASK_INFO, MEMBER_LEVEL_LIST, MEMBER_LIST, MARKETING_TASK_EDIT_INFO, GET_SEARCH_RELATED_USERS, UPDATE_TASK_INFO, UPDATE_MEMBER_INFO } from "@/api";
  export default {
    name: "home",
    data() {
      return {
